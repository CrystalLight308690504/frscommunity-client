 ...
 * description：
 */
public class UserFollowedRecycleViewAdapterViewHolderPresenter {
    private UserFollowedRecycleViewAdapter.ViewHolder view;
    ...
    public UserFollowedRecycleViewAdapterViewHolderPresenter(UserFollowedRecycleViewAdapter.ViewHolder view) {
        this.view = view;
